<%@ Language="C#" MasterPageFile="~/User/Default.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="FanHub.User.Invoice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script>
     window.onload = function () {
         var seconds = 10;
         setTimeout(function () {
             document.getElementById("<%=labelMsg.ClientID %>").style.display = "none";
         }, seconds * 1000);
     };
     </script>
</asp:Content>
    ...
    <div class="container">
        ...
        <div class="container">
            <asp:Repeater ID="OrderItem" runat="server">
                <HeaderTemplate>
                    <table class="table table-responsive-sm table-bordered table-hover" id="tableInvoice">
