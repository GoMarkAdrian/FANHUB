<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="sliderController.ascx.cs" Inherits="FanHub.User.sliderController" %>
                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-6 ">
                            <div class="detail-box">
                                ...
                                <div class="btn-box">
                                    <a href="Shop.aspx" class="btn1">Order Now </a>
                                </div>
                            </div>
                        </div>
                    </div>
