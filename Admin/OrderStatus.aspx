<%@ Page Title="Order Status" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="FanHub.Admin.OrderStatus" %>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-8 col-lg-8">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="OrderStatus_ItemCommand">
                                                        <Headertemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("OderID") %>' CommandName="Edit">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4 mobile-inputs">
                                            <asp:Panel ID="panelUpdateOrderStatus" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="rdvOrderStatus" runat="server" ForeColor="Red" ControlToValidate="ddlOrderStatus"
