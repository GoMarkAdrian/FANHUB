<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="FanHub.Admin.Contact" %>
                                                    ...
                                                    <asp:Repeater ID="rContacts" runat="server" OnItemCommand="rContacts_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <!-- DELETE COMMAND -->
                                                                    <asp:LinkButton ID="CategoryDelete" Text="Delete" runat="server" CssClass="badge badge-danger"
